...
import { Mail, Lock, User, ArrowRight, Map } from 'lucide-react';
...
export const SignUpPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showToast('success', 'Account created! Welcome to Ghoomer.pk!');
      navigate('/');
    } catch (err) {
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 px-6 py-24">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm font-medium">Join Pakistan's premier adventure platform</p>
        </div>
